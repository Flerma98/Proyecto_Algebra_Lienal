...
public class U2_Adjunta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_u2__adjunta);
        txtFilas = findViewById(R.id.txtADJUNTAFila);
        txtColumnas = findViewById(R.id.txtADJUNTAColumna);
        btnCrear = findViewById(R.id.btnADJUNTACrear);
        btnObtener = findViewById(R.id.btnADJUNTAObtener);
        recycler1 = findViewById(R.id.ADJUNTARecycler);
        Rrecycler = findViewById(R.id.ADJUNTARESULTADORecycler);
        btnCrear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (txtFilas.getText().toString().length() == 0 || txtColumnas.getText().toString().length() == 0) {
                    ...
                    recycler1.setLayoutManager(new GridLayoutManager(U2_Adjunta.this, columnas));
            ...
            public void onClick(View view) {
                ...
                for (int i = 0; i < matriz.length; i++) {
                    for (int x = 0; x < matriz[0].length; x++) {
                        arrayList.add(String.valueOf(MainActivity.decimalToFraction(adjunta[i][x])));
                    }
                }
                Rrecycler.setLayoutManager(new GridLayoutManager(U2_Adjunta.this, columnas));
                adapterR = new AdapterDatosResultados(arrayList, filas, columnas);
                Rrecycler.setAdapter(adapterR);
                Rrecycler.setEnabled(false);
                }catch (Exception e){
                    Toast.makeText(U2_Adjunta.this, "No se puede calcular esta matriz", Toast.LENGTH_SHORT).show();}
            }
        });
    }
